...
public:
    ...
    virtual ~ResourceBase() {
        std::cout << "Base resource released in destructor." << std::endl;
    }
...
public:
    ...
    ~DerivedResource() override {
        std::cout << "Derived resource released in destructor." << std::endl;
    }
...
int main() {
    {
        ...
        resource->use();
    }  // Both base and derived resources are released by their respective destructors.
}
